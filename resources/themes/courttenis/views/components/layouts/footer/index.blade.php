...
<footer class="mt-9  max-sm:mt-10 bg-courtBlue">
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        >
            <x-slot:header class="rounded-t-lg bg-courtNavy font-medium max-md:p-2.5 max-sm:px-3 max-sm:py-2 max-sm:text-sm">
                    ...
                    >
                        <div class="relative w-full">
                            <x-shop::form.control-group.control
                                type="email"
                                class="block w-[420px] max-w-full rounded-xl border-2 border-[#e9decc] bg-courtNavy px-5 py-4 text-base max-1060:w-full max-md:p-3.5 max-sm:mb-0 max-sm:rounded-lg max-sm:border-2 max-sm:p-2 max-sm:text-sm"
                                name="email"
    ...
    <div class="flex justify-between bg-courtNavy px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
