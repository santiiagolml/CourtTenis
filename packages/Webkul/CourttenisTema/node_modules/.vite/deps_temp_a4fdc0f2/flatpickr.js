  ...
  "node_modules/flatpickr/dist/flatpickr.js"(exports, module) {
    ...
    function Flatpickr(element, config) {
      ...
      function setHoursFromInputs() {
        ...
        if (self.amPM !== void 0) hours = hours % 12 + 12 * (self.amPM.textContent === "PM");
      ...
      function buildDays(delta) {
        ...
        if (!self.config.animate || delta === void 0) clearNode(self.daysContainer);
        else {
      ...
      function isEnabled(date, timeless) {
        if (self.config.minDate && compareDates(date, self.config.minDate, timeless !== void 0 ? timeless : !self.minDateHasTime) < 0 || self.config.maxDate && compareDates(date, self.config.maxDate, timeless !== void 0 ? timeless : !self.maxDateHasTime) > 0) return false;
      ...
      function onMouseOver(elem) {
        ...
        var _loop = function _loop2(timestamp2, i2) {
          ...
          if (initialDate < hoverDate && timestamp2 === initialDate.getTime()) dayElem.classList.add("startRange");
          else if (initialDate > hoverDate && timestamp2 === initialDate.getTime()) dayElem.classList.add("endRange");
          if (timestamp2 >= minRangeDate && timestamp2 <= maxRangeDate) dayElem.classList.add("inRange");
        };
    ...
    Flatpickr.prototype = {
      ...
      formatDate: function formatDate(dateObj, frmt) {
        var _this = this;
        if (this.config !== void 0 && this.config.formatDate !== void 0) return this.config.formatDate(dateObj, frmt);
